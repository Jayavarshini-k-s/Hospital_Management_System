 ...
 * @author HP
 */
public class PatientOperationsFrame extends javax.swing.JFrame {
    JFrame dashboard;
    /**
     * Creates new form PatientOperationsFrame
     */
    public PatientOperationsFrame(JFrame dashboard) {
        this.dashboard = dashboard;
        initComponents();
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

    // When this frame closes, show dashboard again
    ...
    private void insertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertButtonActionPerformed
        ...
        InsertPatientFrame insertFrame = new InsertPatientFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientOperationsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(()-> {
                new PatientOperationsFrame(null).setVisible(true);        
        });
    }
