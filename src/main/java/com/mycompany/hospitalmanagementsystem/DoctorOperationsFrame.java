 ...
 * @author HP
 */
public class DoctorOperationsFrame extends javax.swing.JFrame {

    JFrame dashboard;
    
    public DoctorOperationsFrame(JFrame dashboard) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorOperationsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(()-> {
                new DoctorOperationsFrame(null).setVisible(true);        
        });
    }
